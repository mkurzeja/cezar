...
function TaskRow({
  ...
  // per row, which is why the registry entry carries `repoUrl` — and its `forge`, from the same
  // row, because a mixed workspace (spec 2026-09-20-gitlab-forge-support D8) can have the row
  // above this one on GitHub and this one on GitLab, where `/pull/N` is a hard 404.
